...
export class ChartService {
    ...
    public chartResponse = new BehaviorSubject<Array<any>>([]);
    //readonly chartResponse = this._chartResponse.asObservable();
    ...
    fetchData(fileName: string = 'Combined_Transformation Roadmap for Verification_Outline 12-13-21.xlsx') {
        fetch(`${this.chartBaseUrl}?file=${this.fileName}`)
        .then(response => response.json()) // or text() or blob() etc.
        .then(data => {
            this.chartResponse.next(data);
        })
        .catch(err => err);
    }
    ...
    //         //     (data) => {
    //         //         // this._chartResponse.next(data.json());
    //         //         return data.json()
    //         //     }
    //         // );
